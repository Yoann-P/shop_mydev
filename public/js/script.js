...
$(window).on("load", function () {
    ...
    /*===================================
            S       HOW HIDE MONTRES HOMMES ET FEMMES
    ======================================*/
    $(".montres-homme").on('click', function () {
        $(".Homme").fadeIn("slow");
        $(".Femme").fadeOut("slow");

        $(".montres-homme").addClass('cbp-filter-item-active');
        $(".montres-femme").removeClass('cbp-filter-item-active');
        $(".montres-all").removeClass('cbp-filter-item-active');
    });

    $(".montres-femme").on('click', function () {
        $(".Homme").fadeOut("slow");
        $(".Femme").fadeIn("slow");
        $(".montres-homme").removeClass('cbp-filter-item-active');
        $(".montres-femme").addClass('cbp-filter-item-active');
        $(".montres-all").removeClass('cbp-filter-item-active');
    });

    $(".montres-all").on('click', function () {
        $(".Homme").fadeIn("slow");
        $(".Femme").fadeIn("slow");
        $(".montres-homme").removeClass('cbp-filter-item-active');
        $(".montres-femme").removeClass('cbp-filter-item-active');
        $(".montres-all").addClass('cbp-filter-item-active');
...
jQuery(function ($) {
    ...
    let qtePanier =  '';
    let urlArticle = $("#qte-panier").attr("href");
    $(document).on('click', '.plus', function () {
        $("#qte-panier").attr("href","") 

        $('.count').val(parseInt($('.count').val()) + 1);
        qtePanier =  $(".count").val()    
        $("#qte-panier").attr("href",urlArticle+'?qte='+qtePanier)
    });
